...
class PingTCP extends _ping.default {
  async send() {
  ...
  static sendAsync(options = {}, callback = () => {}) {
    return new Promise((resolve, reject) => {
      new PingTCP(options).on('result', result => {
        resolve(result);
  ...
  async scan() {
    this.options.ports = !this.options.ports ? [21, 22, 23, 25, 80, 194, 443, 3000, 3306, 5000, 8080, 25565] : this.options.ports;
